...
- дополнительные live-агенты занимают hot desk-места, затем остаются видимыми в
  очереди и нижнем пуле; неизвестные роли получают стабильный fallback-спрайт;
