...
- Интерактивность сцены: DOM/CSS overlay с hotspot агентов, визуальной иерархией,
  передачей задач и карточкой выбранного назначения
...
- Каноническая иллюстрация имеет фиксированную композицию: hotspot и маршруты
  overlay привязаны к её соотношению сторон, а дополнительные агенты отображаются
  в пуле вне основных мест сцены.
